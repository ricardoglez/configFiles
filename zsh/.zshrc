...
plugins=(git history catimg jsontools pip python colored-man-pages extract node npm web-search )
...
#
#plugins=(git catimg  man macports battery nmap node nanoc cp dirhistory emoji emoji-clock zsh_reload zsh-navigation-tools)
...
alias firefoxq="/opt/firefox/firefox"
